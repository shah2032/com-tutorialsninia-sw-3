...
public class LaptopsAndNotebooksTest  extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Brooks");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "William");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "prime1234@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "o7774567890");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "haroow street");
